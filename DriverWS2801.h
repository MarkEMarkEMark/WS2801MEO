...
class DriverWS2801 {
 ...
 public:
  ...
  // Configurable pins:
  DriverWS2801(uint16_t n, uint8_t dpin, uint8_t cpin, uint8_t order=WS2801_RGB);
  DriverWS2801(uint16_t x, uint16_t y, uint8_t dpin, uint8_t cpin, uint8_t order=WS2801_RGB);
  // Use SPI hardware; specific pins only:
  DriverWS2801(uint16_t n, uint8_t order=WS2801_RGB);
