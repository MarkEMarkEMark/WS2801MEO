...
DriverWS2801::DriverWS2801(uint16_t n, uint8_t order) {
	rgb_order = order;
	alloc(n);
	updatePins();
}
...
DriverWS2801::DriverWS2801(uint16_t n, uint8_t dpin, uint8_t cpin, uint8_t order) {
	rgb_order = order;
	alloc(n);
...
DriverWS2801::DriverWS2801(uint16_t w, uint16_t h, uint8_t dpin, uint8_t cpin, uint8_t order) {
	rgb_order = order;
	alloc(w * h);
	width = w;
	height = h;
...
void DriverWS2801::updatePins(void) {
	hardwareSPI = true;
	datapin     = clkpin = 0;
...
void DriverWS2801::updatePins(uint8_t dpin, uint8_t cpin) {
...
void DriverWS2801::updateLength(uint16_t n) {
...
void DriverWS2801::updateOrder(uint8_t order) {
	rgb_order = order;
...
void DriverWS2801::setPixelColor(uint16_t x, uint16_t y, uint8_t r, uint8_t g, uint8_t b) {
...
void DriverWS2801::setPixelColor(uint16_t x, uint16_t y, uint32_t c) {
	boolean evenRow = ((y % 2) == 0);
	// calculate x offset first
	uint16_t offset = x % width;
	if (!evenRow) {
